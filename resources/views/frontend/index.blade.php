                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="post medium-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                       <img class="img-responsive" src="images/tales/mother_africa.png" alt="" />
                                   </div>
                               </div>
                               <div class="post-content2">
                                <div class="entry-content">
                                    <h2 class="entry-title">
                                        The 20th Century was drawing to a close when the press release came: “ALL HUMANS ON PLANET EARTH ARE DESCENDED FROM AN AFRICAN WOMAN”. I screamed! to the hearing of 
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="post medium-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="images/tales/palavar-hall-bg.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="post-content2">
                                    <div class="entry-content">
                                        <h2 class="entry-title">
                                            Yunhouse generation of Africans
                                            ...
                                            on this unsurpassable episode of man’s inhumanity to man. 
                                            <span class="read-more"><a href="{{ url('/debate-index') }}"></br>Join the Debate in Palaver Hall</a></span></h2>
                                        </div>
                                    </div>
                                </div><!--/post--> 
