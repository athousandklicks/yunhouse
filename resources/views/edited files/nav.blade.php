    ...
    <div class="navbar" role="banner">
        <div class="container">
            <div class="top-add">
                ...
                <h4 class="top-author">A Novel by Ad'Obe Obe | Country: Nigeria | Language: English | Publisher: Apaugasma Communications Limited | Publication Date: 2016 | Genre: Novel | ISBN 978-1-9998641-0-1</h4>
                        ...
                        <li class="environment dropdown mega-dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">About the Author</a>
                            <div class="dropdown-menu mega-menu">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <h3 class="sub-nav-heading">Meet Ad'Obe Obe</h2>
                                            ...
                                            <div class="col-sm-3">
                                                <h3 class="sub-nav-heading">DREAMING YUNHOUSE</h2>
