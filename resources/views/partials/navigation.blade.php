		...
		<div class="container-fluid">	
			...
			<nav id="mainmenu" class="navbar-left collapse navbar-collapse"> 
				<ul class="nav navbar-nav">                       
					...
					@if (Auth::check())
					<li class="sports"><a href="/list-of-tales"> Enter Palaver Hall</a></li>
					@else
					<li class="environment dropdown mega-dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Enter Palaver Hall</a>
						<div class="dropdown-menu mega-menu">
							<div class="container">
								<div class="row">
									<div class="col-sm-6">
