...
@section('title', "| Characters - Cyril Naikule")
...
<p>Cy dies (c1994) while working on the case against the takeover of Yunhouse by rival Adventurers Club.</p>
                 </div>
                 <!-- /#post-content -->
             </div>
             <!-- /.box -->
