...
<div class="page-breadcrumbs">
    <h1 class="section-title"> John O'Gafla</h1>
</div>
<div class="section">
    <div class="row">
        <div class="col-sm-9">
                ...
                <div class="author-details">
                    ...
                    <div class="author-info">
                        ...
                        <p class="lead">
                            ...
                            <p class="lead">John O’Gafla is the founder member of the first ever batch of The Africa Correspondents, an informal pints gang of real ale enthusiasts in Fleet Street which metamorphoses into The Africa Adventurers Club. His one African dream is to witness the amalgamation of Yunhouse with The Adventurers. But he, of all people, knows that the task would be as difficult as it would be for him (certificated obese all his life) Climbing Mount Kilimanjaro (title of his unpublished memoirs). Especially given the well-known fact that he is the principal architect in the establishment of AFC (Africa Freedom Council) with which reconciliation with Yunhouse is beyond imagination.
                            </p>
