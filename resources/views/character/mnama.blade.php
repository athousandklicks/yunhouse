...
<div class="page-breadcrumbs">
    <h1 class="section-title"> Big Mnama</h1>
</div>
<div class="section">
    <div class="row">
        <div class="col-sm-9">
